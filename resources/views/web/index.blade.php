            ...
            <div class="row ipad-width">
                <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="slick-multiItem">
                                        ...
                                        <div class="slide-it">
                                            <div class="movie-item">
                                                <div class="mv-img">
                                                    <img src="{!!asset($articlesRecen->image)!!}" alt="" width="185"
                                                        height="284">
                                                </div>
                                                <div class="hvr-inner">
                                                    <a href="{{route('web.single',$articlesRecen->slug)}}">Descargar<i
                                                            class="ion-android-arrow-dropright"></i> </a>
                                                </div>
                                                <div class="title-in">
                                                    <h6><a
                                                            href="{{route('web.single',$articlesRecen->slug)}}">{{$articlesRecen->name}}</a>
                                                    </h6>
                                                    <p><i
                                                            class="ion-android-download"></i><span>{{$articlesRecen->visits}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="title-hd">
                        ...
                        <a href="{{route('web.popular')}}" class="viewall">Populares <i
                                ...
                                <div class="row">
                                    <div class="slick-multiItem">
                                        ...
                                        <div class="slide-it">
                                            <div class="movie-item">
                                                <div class="mv-img">
                                                    <img src="{!!asset($article->image)!!}" alt="" width="185"
                                                        height="284">
                                                </div>
                                                <div class="hvr-inner">
                                                    <a href="{{route('web.single',$article->slug)}}">Descargar<i
                                                            class="ion-android-arrow-dropright"></i> </a>
                                                </div>
                                                <div class="title-in">
                                                    <h6><a
                                                            href="{{route('web.single',$article->slug)}}">{{$article->name}}</a>
                                                    </h6>
                                                    <p><i
                                                            class="ion-android-download"></i><span>{{$article->visits}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
